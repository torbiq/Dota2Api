...
namespace Dota2API.Network {
    public static class API {
        ...
        public static MatchDetails GetMatchDetails(string key, UInt64 match_id)  {
        ...
        public static List<Hero> GetHeroes(string key, string language = null, bool itemizedOnly = false) {
        ...
        public static List<GameItem> GetGameItems(string key, string language = null) {
        ...
        public static MatchHistoryBySequenceNum GetMatchHistoryBySequenceNum(string key, UInt64? startAtMatchSeqNum = null, uint matchesRequested = 0) {
            string resultJSON = GetStringAsync(getHeroesURL
        ...
        public static MatchHistory GetMatchHistory(MatchDetailsRequest request) {
